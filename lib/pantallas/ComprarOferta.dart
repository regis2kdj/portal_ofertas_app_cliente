...
class ComprarOferta extends StatefulWidget {
  ComprarOferta({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ComprarOfertaState createState() => _ComprarOfertaState();
}

class _ComprarOfertaState extends State<ComprarOferta> {
  ...
  Widget _title() {
    return RichText(
        ...
        text: TextSpan(
            text: 'Ofertas App - Comprar Oferta',
