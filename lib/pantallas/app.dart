...
class SplashScreenState extends State<SplashScreen>
  ...
  double overall = 3.0;
  String overallStatus = "Bien";
  int curIndex = 0;
  String usingTimes = 'Diariamente';
  ...
  List<SecondQuestion> usingCollection = [
    SecondQuestion('daily', 'Diariamente'),
    SecondQuestion('onceAWeek', 'Una vez a la semana'),
    SecondQuestion('onceAMonth', 'Una vez al mes'),
    SecondQuestion('everyMoths', 'Cada 2-3 meses'),
    SecondQuestion('lessThanYears', 'Una vez al año'),
  ];
      ...
      bottomNavigationBar: _animateController.isCompleted
          ? BottomAppBar(
              ...
              child: GestureDetector(
                ...
                child: Center(
                    child: Text(
                  curIndex < 3 ? 'Continuar' : 'Finalizar',
          ...
          child: Row(
            ...
            children: List.generate(4, (int index) {
              return Container(
                decoration: BoxDecoration(
//                    color: Colors.blueGrey,
                  color: index <= curIndex ? Colors.blueGrey : Colors.grey,
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
                ...
                child: Text('En general, ¿cómo calificaría nuestro servicio?')),
            Container(
          ...
          child: Opacity(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                    margin: EdgeInsets.only(top: 16.0),
                    child: Text('Con que frecuencia usualmente utilizas nuestro servicio?')),
                Expanded(
                  child: Center(
                    child: Container(
                      height: 258.0,
  ...
  List<ThirdQuestion> thirdQuestionList = [
    ThirdQuestion('Precio bastante más barato', false),
    ThirdQuestion('Gran cantidad de ofertas', false),
    ThirdQuestion('Fácil de usar', false),
    ThirdQuestion('Servicio al cliente amigable', false),
  ];
          ...
          child: Opacity(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                    margin: EdgeInsets.only(top: 16.0),
                    child: Text('Que te gusta de nuestro servicio?')),
                Expanded(
                  child: Center(
                    child: Container(
                      height: 213.0,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                    margin: EdgeInsets.only(top: 16.0),
                    child: Text(
                        'Cuando necesitas ayuda o tienes inquietudes relacionadas con nuestro producto, ¿qué tan satisfecho está con nuestro servicio de atención al cliente?')),
                Expanded(
                  child: Center(
                    child: Container(
                      height: 213.0,
...
//                    color: Colors.blueGrey,
                            color:
                                index == 0 ? Colors.blueGrey : Colors.grey,
                            borderRadius:
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Sólo tomará unos segundos y nos ayudará a mejorar el servicio, gracias por participar!',
                      style: TextStyle(
                        fontSize: 16.0,
                      ),
                    ),
